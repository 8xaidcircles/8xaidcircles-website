    ...
    <Layout>
      <div className="max-w-8xl mx-auto px-4 3xl:px-8 4xl:px-12 5xl:px-16 pt-32 3xl:pt-40 4xl:pt-48 pb-12 3xl:pb-16 4xl:pb-20">
        ...
        <div className="space-y-6 3xl:space-y-8 4xl:space-y-10 text-gray-700 text-base 3xl:text-lg 4xl:text-xl 5xl:text-2xl leading-relaxed">
          ...
          <section>
            <h2 className="text-xl 3xl:text-2xl 4xl:text-3xl 5xl:text-4xl font-semibold mb-4 3xl:mb-6 4xl:mb-8">1．個人情報の取得と利用目的</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl 3xl:text-2xl 4xl:text-3xl 5xl:text-4xl font-semibold mb-4 3xl:mb-6 4xl:mb-8">2．個人情報の第三者提供</h2>
          ...
          <section>
            <h2 className="text-xl 3xl:text-2xl 4xl:text-3xl 5xl:text-4xl font-semibold mb-4 3xl:mb-6 4xl:mb-8">3．個人情報の委託</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl 3xl:text-2xl 4xl:text-3xl 5xl:text-4xl font-semibold mb-4 3xl:mb-6 4xl:mb-8">4．個人情報の管理と安全対策</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl 3xl:text-2xl 4xl:text-3xl 5xl:text-4xl font-semibold mb-4 3xl:mb-6 4xl:mb-8">5．個人情報の開示・訂正・利用停止等</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl 3xl:text-2xl 4xl:text-3xl 5xl:text-4xl font-semibold mb-4 3xl:mb-6 4xl:mb-8">6．Cookie等の利用について</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl 3xl:text-2xl 4xl:text-3xl 5xl:text-4xl font-semibold mb-4 3xl:mb-6 4xl:mb-8">7．改定について</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl 3xl:text-2xl 4xl:text-3xl 5xl:text-4xl font-semibold mb-4 3xl:mb-6 4xl:mb-8">8．お問い合わせ先</h2>
            <p>
              個人情報に関するお問い合わせは、以下のメールアドレスまでご連絡ください。
            </p>
            <div className="mt-2 3xl:mt-4 4xl:mt-6">
