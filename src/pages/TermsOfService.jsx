      ...
      <div className="max-w-8xl mx-auto px-4 3xl:px-8 4xl:px-12 5xl:px-16 pt-32 3xl:pt-40 4xl:pt-48 pb-12 3xl:pb-16 4xl:pb-20">
        ...
        <div className="space-y-6 3xl:space-y-8 4xl:space-y-10 text-gray-700 text-base 3xl:text-lg 4xl:text-xl 5xl:text-2xl leading-relaxed">
          ...
          <section>
            ...
            <p>
              この利用規約（以下「本規約」といいます）は、8X Aid Circles（以下「当社」といいます）が提供する以下のサービス（以下総称して「本サービス」といいます）の利用条件を定めるものです。
            </p>
          ...
          <section>
            ...
            <ol className="list-decimal ml-6 3xl:ml-8 4xl:ml-10 space-y-2 3xl:space-y-3 4xl:space-y-4">
              <li>当社は、ユーザーに対し、本サービスが提供する文章、画像、動画、音声、音楽、ソフトウェア、プログラム、コードその他のコンテンツについて、本サービスの利用範囲内における私的な利用を許諾します。</li>
              <li>有償コンテンツについては、当社が定める利用料金の支払が完了した場合に、本サービスの利用範囲内における私的な利用を許諾します。これは、譲渡及び再許諾できない、非独占的な利用権です。</li>
          ...
          <section>
            ...
            <ol className="list-decimal ml-6 3xl:ml-8 4xl:ml-10 space-y-2 3xl:space-y-3 4xl:space-y-4">
              <li>本サービスおよび本サービスに関連するウェブサイト、ソフトウェア、コンテンツ（文章、画像、動画、プログラム、デザイン、商標等を含みます）に関する一切の知的財産権は、当社または当社にライセンスを許諾している者に帰属します。</li>
          ...
          <section>
            ...
            <p>
              当社が提供する検索サービス（8Wheel）は、ユーザーが入力した検索クエリに基づき、インターネット上の情報を検索し、その結果を表示するものです。
            </p>
            ...
            <ol className="list-decimal ml-6 3xl:ml-8 4xl:ml-10 space-y-2 3xl:space-y-3 4xl:space-y-4">
              ...
              <li>検索結果の正確性、完全性、有用性、適時性について、当社は一切保証いたしません。</li>
              <li>検索結果として表示されるウェブサイトの内容については、各ウェブサイトの運営者が責任を負うものとし、当社は一切の責任を負いません。</li>
              <li>検索結果の表示順位やランキングについて、当社は一切保証せず、責任を負いません。</li>
            </ol>
            ...
            <ol className="list-decimal ml-6 3xl:ml-8 4xl:ml-10 space-y-2 3xl:space-y-3 4xl:space-y-4">
              ...
              <li>検索履歴の取扱いの詳細については、当社のプライバシーポリシーをご確認ください。</li>
            </ol>
            ...
            <ol className="list-decimal ml-6 3xl:ml-8 4xl:ml-10 mt-2 3xl:mt-4 4xl:mt-6 space-y-2 3xl:space-y-3 4xl:space-y-4">
              ...
              <li>検索結果を利用して、当社の競合サービスを構築する行為</li>
              <li>その他、当社が不適切と判断する検索結果の利用</li>
            </ol>
            ...
            <p>当社は、以下の場合、事前通知なく検索サービスの利用を制限または停止できるものとします。</p>
            <ol className="list-decimal ml-6 3xl:ml-8 4xl:ml-10 mt-2 3xl:mt-4 4xl:mt-6 space-y-2 3xl:space-y-3 4xl:space-y-4">
              <li>過度なアクセスや自動化されたクエリの送信が確認された場合</li>
              <li>検索結果の不正な収集や再配布が確認された場合</li>
              <li>その他、当社が不適切と判断する利用があった場合</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal ml-6 3xl:ml-8 4xl:ml-10 mt-4 3xl:mt-6 4xl:mt-8 space-y-2 3xl:space-y-3 4xl:space-y-4">
              ...
              <li>本サービスまたは当社ウェブサイトに対して、過度なアクセスやクローリング、スクレイピングを行う行為</li>
              <li>検索結果やサイトコンテンツを、当社の許可なく自動的に収集、複製、再配布する行為</li>
          ...
          <section>
            ...
            <ol className="list-decimal ml-6 3xl:ml-8 4xl:ml-10 space-y-4 3xl:space-y-6 4xl:space-y-8">
              ...
              <li>当社は、この場合にユーザーまたは第三者が被ったいかなる不利益または損害についても、一切の責任を負わないものとします。</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal ml-6 3xl:ml-8 4xl:ml-10 space-y-2 3xl:space-y-3 4xl:space-y-4">
              <li>当社は、本サービスに関してユーザーに生じたあらゆる損害について一切の責任を負いません。ただし、本サービスに関する当社とユーザーとの間の契約（本規約を含みます）が消費者契約法に定める消費者契約となる場合、この免責規定は適用されません。</li>
              <li>消費者契約に該当する場合であっても、当社は、当社の過失（重過失を除きます）によってユーザーに生じた損害のうち、ユーザーに直接かつ現実に発生した損害についてのみ賠償責任を負うものとし、また、その賠償額は、本サービスの利用料金の直近1ヶ月分または金1万円のいずれか低い方を上限とします。</li>
            </ol>
            ...
            <ol className="list-decimal ml-6 3xl:ml-8 4xl:ml-10 space-y-2 3xl:space-y-3 4xl:space-y-4">
              <li>検索結果の表示内容や順位について、当社は一切保証せず、責任を負いません。</li>
              <li>検索結果から遷移した外部サイトでの取引、トラブル、損害について、当社は一切の責任を負いません。</li>
              <li>検索結果に表示される広告について、当社は広告内容の正確性を保証せず、広告主との取引について一切の責任を負いません。</li>
            </ol>
            ...
            <p>
              本サービスには、第三者が運営するウェブサイトへのリンクが含まれる場合があります。当社は、リンク先のウェブサイトの内容について、一切の責任を負いません。
            </p>

            <h3 className="text-lg 3xl:text-xl 4xl:text-2xl font-semibold mt-6 3xl:mt-8 4xl:mt-10 mb-3 3xl:mb-4 4xl:mb-5">第4項（広告について）</h3>
            <p>
              本サービスには、当社または第三者の広告が表示されることがあります。広告の内容について、当社は一切の責任を負いません。
            </p>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal ml-6 3xl:ml-8 4xl:ml-10 space-y-2 3xl:space-y-3 4xl:space-y-4">
              <li>ユーザーと当社との間の通知または連絡は、当社の定める方法によって行うものとします。</li>
              <li>当社は、ユーザーから、当社が別途定める方式に従った変更届け出がない限り、現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い、これらは、発信時にユーザーへ到達したものとみなします。</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal ml-6 3xl:ml-8 4xl:ml-10 space-y-2 3xl:space-y-3 4xl:space-y-4">
              ...
              <li>当社は本サービスに関し、本規約のほか、ご利用にあたってのルールを定めることがあります。これらのルールは、その名称のいかんに関わらず、本規約の一部を構成するものとします。</li>
